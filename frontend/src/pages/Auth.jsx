          ...
          <CardFooter className="flex flex-col gap-3 p-6 pt-0">
            ...
            <div className="grid grid-cols-1 gap-3">
              <Button
                ...
                className="w-full bg-white border-slate-200 text-slate-700 hover:bg-slate-50 rounded-xl h-11 font-medium text-sm flex items-center justify-center gap-2 shadow-sm transition-all active:scale-[0.98]"
              >
