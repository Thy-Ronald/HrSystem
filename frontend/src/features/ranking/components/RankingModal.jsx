  ...
  return (
    ...
    >
      <div className="p-6">
        <div className="flex flex-col sm:flex-row gap-4 mb-6">
          ...
          <div className="flex-1">
            <div className="flex flex-col gap-1 relative w-full">
              <label htmlFor="type-select" className="text-sm font-medium text-[#5f6368] dark:text-slate-400">
                Type
              </label>
              <select
                id="type-select"
        ...
        <div className="border border-gray-200 dark:border-slate-800 rounded-lg overflow-hidden h-[500px] flex flex-col">
          {selectedRepos.length === 0 ? (
            <div className="flex items-center justify-center h-full text-[#70757a] dark:text-slate-500">
